...
* `6.3`, `6.3.3.4`, `latest` - Splunk Enterprise
* `6.3-light`, `6.3.3.4-light`, `latest-light` - Splunk Light
* `6.3-forwarder`, `6.3.3.4-forwarder`, `latest-forwarder` - Splunk Universal Forwarder
...
```bash
docker pull outcoldman/splunk:6.3.3.4
```
...
```bash
docker run --hostname splunk -p 8000:8000 -d outcoldman/splunk:6.3.3.4
```
...
docker run --hostname splunk --name splunk --volumes-from=vsplunk -p 8000:8000 -d outcoldman/splunk:6.3.3.4
```
...
splunk:
  image: outcoldman/splunk:6.3.3.4
  hostname: splunk
  volumes_from:
    - vsplunk
  ports:
