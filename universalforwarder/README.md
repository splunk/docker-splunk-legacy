...
* `7.0.1`, `latest` - Splunk universal forwarder base image [Dockerfile](https://github.com/splunk/docker-splunk/blob/master/enterprise/Dockerfile)
...
The `7.0.1-monitor` tag ensures that the universal forwarder has the data inputs you need to get stats from a Docker container.

```bash
docker pull splunk/universalforwarder:7.0.1-monitor
```

### Pull the latest version of the image from this repository
The `7.0.1` and `latest` versions only have the forwarder and do not have any of the data inputs.
=======
...
services:
  splunkuniversalforwarder:
    ...
    image: splunk/universalforwarder:7.0.1
...
`splunk/universalforwarder:7.0.1` and `splunk/universalforwarder:latest`
